...
class MicroPost
{
    ...
    #[Assert\NotBlank()]
    #[Assert\Length(min: 5, max:255, minMessage: 'Le titre est trop court, 5 caractères minimum.')]
    private ?string $title = null;

    #[ORM\Column(length: 500)]
    #[Assert\NotBlank()]
    #[Assert\Length(min: 5, max:500, minMessage: 'Le contenu est trop court, 5 caractères minimum.')]
